...
class ResNet5Block(torch.nn.Module):
    def __init__(self, num_filters=32,input_channel = 1, filter_size=3, T=4, num_filters_start=2, num_filters_end=2, batch_norm=False):
        super(ResNet5Block, self).__init__()
        num_filters_start = num_filters_end = input_channel
        if batch_norm:
